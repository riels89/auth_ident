...
class large_contrastive_cnn():

    def __init__(self):

        self.name = "large_contrastive_cnn"
    ...
    def create_model(self, params, index, logger):
        ...
        non_linearity_1 = Dense(2048, activation="relu", name="non_linearity_1")
        non_linearity_2 = Dense(2048, activation="relu", name="non_linearity_2")
